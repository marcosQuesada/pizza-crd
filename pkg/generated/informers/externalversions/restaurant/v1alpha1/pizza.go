...
import (
	...
	v1alpha1 "github.com/programming-kubernetes/pizza-crd/pkg/generated/listers/restaurant/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RestaurantV1alpha1().Pizzas(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RestaurantV1alpha1().Pizzas(namespace).Watch(context.Background(), options)
			},
		},

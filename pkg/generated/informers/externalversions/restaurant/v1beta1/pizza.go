...
import (
	...
	restaurantv1beta1 "github.com/programming-kubernetes/pizza-crd/pkg/apis/restaurant/v1beta1"
	versioned "github.com/programming-kubernetes/pizza-crd/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/programming-kubernetes/pizza-crd/pkg/generated/informers/externalversions/internalinterfaces"
	v1beta1 "github.com/programming-kubernetes/pizza-crd/pkg/generated/listers/restaurant/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RestaurantV1beta1().Pizzas(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RestaurantV1beta1().Pizzas(namespace).Watch(context.Background(), options)
			},
		},

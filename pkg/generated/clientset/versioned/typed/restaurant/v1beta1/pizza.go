...
import (
	...
	v1beta1 "github.com/programming-kubernetes/pizza-crd/pkg/apis/restaurant/v1beta1"
	scheme "github.com/programming-kubernetes/pizza-crd/pkg/generated/clientset/versioned/scheme"
...
type PizzaInterface interface {
	Create(context.Context, *v1beta1.Pizza) (*v1beta1.Pizza, error)
	Update(context.Context, *v1beta1.Pizza) (*v1beta1.Pizza, error)
	UpdateStatus(context.Context, *v1beta1.Pizza) (*v1beta1.Pizza, error)
	Delete(ctx context.Context, name string, options *v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(ctx context.Context, name string, options v1.GetOptions) (*v1beta1.Pizza, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.PizzaList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Pizza, err error)
	PizzaExpansion
}
...
func (c *pizzas) Create(ctx context.Context, pizza *v1beta1.Pizza) (result *v1beta1.Pizza, err error) {
	result = &v1beta1.Pizza{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("pizzas").
...
func (c *pizzas) Update(ctx context.Context, pizza *v1beta1.Pizza) (result *v1beta1.Pizza, err error) {
	result = &v1beta1.Pizza{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pizzas").
...
func (c *pizzas) UpdateStatus(ctx context.Context, pizza *v1beta1.Pizza) (result *v1beta1.Pizza, err error) {
	result = &v1beta1.Pizza{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("pizzas").
...
func (c *pizzas) Delete(ctx context.Context, name string, options *v1.DeleteOptions) error {
...
func (c *pizzas) DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *pizzas) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Pizza, err error) {
	result = &v1beta1.Pizza{}

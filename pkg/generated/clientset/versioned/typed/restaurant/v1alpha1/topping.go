...
type ToppingInterface interface {
	Create(context.Context, *v1alpha1.Topping) (*v1alpha1.Topping, error)
	Update(context.Context, *v1alpha1.Topping) (*v1alpha1.Topping, error)
	Delete(ctx context.Context, name string, options *v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(ctx context.Context, name string, options v1.GetOptions) (*v1alpha1.Topping, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.ToppingList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Topping, err error)
	ToppingExpansion
}
...
func (c *toppings) Create(ctx context.Context, topping *v1alpha1.Topping) (result *v1alpha1.Topping, err error) {
	result = &v1alpha1.Topping{}
	err = c.client.Post().
		Resource("toppings").
		Body(topping).
...
func (c *toppings) Update(ctx context.Context, topping *v1alpha1.Topping) (result *v1alpha1.Topping, err error) {
	result = &v1alpha1.Topping{}
	err = c.client.Put().
		Resource("toppings").
		Name(topping.Name).
...
func (c *toppings) Delete(ctx context.Context, name string, options *v1.DeleteOptions) error {
...
func (c *toppings) DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *toppings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Topping, err error) {
	result = &v1alpha1.Topping{}
